...
class HandleRequestOptsBuilder {
	types = new Map([
		["create", "create"],
		["update", "update"],
		["delete", "delete"],
...
class HandleRequestOptsDirector {
	constructor(builder){
...
const builtReqParams = new RequestParamsBuilder()
	//.withMethod("get")
	.withUrl("/application")
	.withUrlParams("application")
	.withData({ application: 1})
	.isAuthenticated()
	.build()

// console.log("Req Params ", builtReqParams);

/*const options = new HandleRequestOptsBuilder()
	.withType("delete")
	.withReqParams(builtReqParams)
	.withEntity("application")
	.build();*/



const options = new HandleRequestOptsDirector(new HandleRequestOptsBuilder()).delete("application", builtReqParams).reset();
// const options = new HandleRequestOptsDirector(new HandleRequestOptsBuilder()).delete("application", builtReqParams).done();
